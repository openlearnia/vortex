...
pub(crate) fn new_exporter(
    ...
    match array.execute::<Canonical>(ctx)? {
        ...
        Canonical::Map(array) => {
            list_view::new_exporter(array.into_data_parts().entries, cache, ctx)
        }
        ...
        Canonical::Union(array) => union::new_exporter(array, cache, ctx),
        Canonical::Extension(ext) => extension::new_exporter(ext, cache, ctx),
        Canonical::Variant(_) => {
